...
const styles = {
  note: {
    container:
      "bg-neutral-50 dark:bg-neutral-800/60 dark:ring-1 dark:ring-neutral-300/10",
    title: "text-neutral-900 dark:text-neutral-400",
    body: "text-neutral-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-neutral-900 prose-code:text-neutral-900 dark:text-neutral-300 dark:prose-code:text-neutral-300",
  },
  warning: {
    container:
