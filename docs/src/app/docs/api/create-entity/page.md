...
### `createEntity(options)` {% class="break-all" %}
...
| ---------------------- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `attributes`           | {% badge content="object" /%} {% badge content="optional" /%}   | An optional record of [attributes definitions](/docs/api/create-attribute). Defaults to `{}`.                                                                                                                                                                                                                                                                                                                                                                     |
...
| `metadata`             | {% badge content="unknown" /%} {% badge content="optional" /%}  | An optional field for associating any kind of metadata with the entity.                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `validate`             | {% badge content="function" /%} | A validation function for checking entity values during interpreter validation.                                                                                           |
...
| `metadata`             | {% badge content="unknown" /%}  | An optional field for associating any kind of metadata with the entity.                                                                                                   |
...
| `schema`   | {% badge content="object" /%} | The current generic schema, including all generic entities instances. |
| `entities` | {% badge content="object" /%} | A record of all entities instances and their values.                  |
...
The `validate` method in an attribute's extension receives the same arguments as the base `validate` method of the attribute, except the [context object](/docs/api/create-attribute#context) also includes an additional `context.validate(value)` method, essentially represents the base validation of the attribute. Invoking it is optional, allowing you to entirely replace the validation with custom logic.
